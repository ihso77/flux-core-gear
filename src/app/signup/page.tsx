...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Loader2, Github, Chrome, Check } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-background py-3 px-4 font-body text-sm text-foreground placeholder:text-muted-foreground outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-xl border border-border bg-background py-3 px-4 pr-11 font-body text-sm text-foreground placeholder:text-muted-foreground outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20"
                />
                <button
                  type="button"
